...
'導航至 黑貓宅急便'
WebUI.navigateToUrl('https://dev.dailypro.com.tw/category/181/712/')

WebUI.waitForPageLoad(2)

'選取寄送包裹種類'
WebUI.click(findTestObject('Object Repository/Page_service/input_package'))
WebUI.click(findTestObject('Object Repository/Page_service/input_package-type'))

'選取品項 [運什費]寄件品長寬高總和<60cm'
...
'配達資訊'
//收件人姓名*
WebUI.setText(findTestObject('Object Repository/Page_service/input_delivery-name'), '我是收件人')
//收件人電話*
WebUI.setText(findTestObject('Object Repository/Page_service/input_delivery-phone'), '0944111101')
//收件人地址*
WebUI.click(findTestObject('Object Repository/Page_service/input_delivery-city'))
